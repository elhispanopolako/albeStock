        ...
        <div className="fixed inset-0 bg-black/45 backdrop-blur-sm flex items-center justify-center p-4 z-[999]" role="dialog" aria-modal="true">
            <div className="w-full max-w-[680px] bg-white rounded-2xl overflow-hidden shadow-2xl">
                <div className="p-4 border-b border-neutral-200 flex items-center justify-between">
                    <div className="font-extrabold text-lg text-neutral-900">Dodaj produkt</div>
                ...
                <div className="p-4 grid gap-3">
                    ...
                    <label className="grid gap-1.5">
                        ...
                        <input value={name} onChange={(e) => setName(e.target.value)} placeholder="Np. Mykobooster" className="w-full px-3 py-2 border border-neutral-300 rounded-xl outline-none focus:border-blue-500 transition-colors" />
                    </label>
                    ...
                    <label className="grid gap-1.5">
                        ...
                        <input value={size} onChange={(e) => setSize(e.target.value)} placeholder='Np. "125 ml" / "200 g"' className="w-full px-3 py-2 border border-neutral-300 rounded-xl outline-none focus:border-blue-500 transition-colors" />
                    </label>

                    <div className="grid grid-cols-2 gap-3">
                        <label className="grid gap-1.5">
                            <span className="text-xs text-neutral-500 font-bold">Stan początkowy (szt.)</span>
                            <input type="text" inputMode="numeric" pattern="[0-9]*" value={stock} onChange={(e) => setStock(e.target.value)} className="w-full px-3 py-2 border border-neutral-300 rounded-xl outline-none focus:border-blue-500 transition-colors" />
                        </label>
